                                ...
                                <td key={field} style={{ padding: 0, border: '1px solid #E5E7EB', background: isNumeric ? '#FDFDEA' : 'white' }}>
                                  {['supply_gst_rate', 'service_gst_rate'].includes(field) ? (
                                    <select
                                      ...
                                      style={{ width: '100%', border: 'none', padding: '4px', fontSize: '0.65rem', outline: 'none', background: 'transparent' }}
                                    >
                                    ...
                                    <input
                                      ...
                                      style={{ width: '100%', border: 'none', padding: '4px', fontSize: '0.65rem', outline: 'none', background: 'transparent', textAlign: isNumeric ? 'right' : 'left' }}
                                    />
                                  )}
                                </td>
                              );
              ...
              <table style={{ width: 'max-content', minWidth: '100%', borderCollapse: 'separate', borderSpacing: 0, fontSize: '0.6rem' }}>
                <thead style={{ position: 'sticky', top: 0, zIndex: 20, background: '#F9FAFB' }}>
                  <tr style={{ whiteSpace: 'nowrap' }}>
                    ...
                    <th rowSpan="2" style={{ padding: '2px 3px', border: '1px solid #E5E7EB', background: '#F9FAFB', width: '30px' }}>Del</th>
                  </tr>
                  <tr style={{ whiteSpace: 'nowrap' }}>
          ...
          <div>
            ...
            <div style={{ background: '#F9FAFB', padding: '24px', borderRadius: '12px', border: '1px solid #E5E7EB', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '32px', marginBottom: '24px' }}>
              ...
              <div style={{ textAlign: 'right' }}>
                <p style={{ margin: '0 0 4px' }}><strong>Overall Subtotal:</strong> ₹{getSummaryTotals().taxable.toLocaleString()}</p>
                <p style={{ margin: '0 0 4px' }}><strong>Overall GST:</strong> ₹{getSummaryTotals().gst.toLocaleString()}</p>
                <p style={{ fontSize: '1.5rem', color: '#111827', margin: 0 }}><strong>Grand Total:</strong> ₹{getSummaryTotals().grandTotal.toLocaleString()}</p>
              </div>
            </div>
